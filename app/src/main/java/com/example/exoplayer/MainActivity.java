...
public class MainActivity extends AppCompatActivity implements OnBannerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<com.example.exoplayer.View> data = new ArrayList<>();
        com.example.exoplayer.View view = new com.example.exoplayer.View(R.drawable.a,"DSDSADA","https://www.bilibili.com/video/av47012859/");
        data.add(view);
        viewlistadapter = new ViewListAdapter(data, new ViewListAdapter.OnItemClickListener() {
            @Override
            public void OnItemClick(android.view.View v, int position, String id) {
                String url = ViewLab.get().getView(position).getUrl();
